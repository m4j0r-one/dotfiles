...
// [0, sqrt(2)/3]
#define GLOW_COLOR_OVERRIDE_THRESHOLD 1.0
// Override color for current cursor
// [0, 1]^3
#define GLOW_COLOR_OVERRIDE_CURRENT 0.0, 0.898, 1.0
// Override color for previous cursor
// [0, 1]^3
#define GLOW_COLOR_OVERRIDE_PREVIOUS 1.0, 0.169, 0.839
// Brightness offset for glow effect
// [0, 1]
#define GLOW_COLOR_OFFSET_BRIGHTNESS 0.75
// Time slowdown factor for animations
// x \in R : x > 0
#define TIME_DURATION_FACTOR 2.5
